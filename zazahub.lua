...
MainSection:NewButton("Fly", "Fly Around!", function()
...
MainSection:NewButton("Script Search", "Search and execute any script", function()
_G.posX = 0.405
_G.posY = 0.9
_G.searchButton = ";"
_G.commandPrefix = "/"
...
MainSection:NewButton("Admin", "Gives you infinite yield, a very popular admin script", function()
...
BloxfruitsSection:NewButton("BF Script", "New and OP BF script", function()
...
DahoodSection:NewButton("DH Script", "Many usefull features", function()
...
EspSection:NewButton("ESP", "Simple ESP", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/DylanIsAKingL/Lua-Scripts/main/Customizable-Esp.lua"))()
end)
...
local JailSection = Jail:NewSection("Jailbreak")

JailSection:NewButton("Jailbreak Script", "OP", function()
loadstring(game:HttpGet('https://scripts.luawl.com/14245/JailbreakerFree.lua'))()
end)


--Trolling
local E = Window:NewTab("Trolling")
local ESection = E:NewSection("Trolling")


ESection:NewButton("RemX", "RemX, multi tool GUI, many features", function()
loadstring(game:HttpGet(('https://raw.githubusercontent.com/Henry887/RemX-Script-Hub/main/main.lua'),true))()
end)


ESection:NewButton("Btools", "Can control the world", function()
...
ESection:NewButton("Fling All", "Mega Fling", function()
